    ...
    for mask_image in glob.glob(os.path.join(maskpath, f'*.{MASK_EXT}')):
        ...
        for contour in contours:
            ...
            annotation = {
                ...
                "id": annotation_id,
                "image_id": image['id'],
                "category_id": category_ids['Shrock'],
                "bbox": bbox,
                "area": area,
...
def process_masks(mask_path, dest_json):
    ...
    coco_format = {
        "info": {
            "year": "2025",
            "version": "1",
            "description": "images obtained for the purpose of rock sgmentation from a simulated lunar environment",
            "contributor": "Roboflow",
            "date_created": "2025-02-16T00:00:00+00:00"
        },
        "licenses": [],
        "images": [],
    ...
    coco_format["images"], _, annotation_cnt = images_annotations_info(mask_path)
...
if __name__ == "__main__":
    ...
    train_json_path = "./input/train_masks/train.json"
    process_masks(train_mask_path, train_json_path)

    val_mask_path = "./input/val_masks/"
    val_json_path = "./input/val_masks/val.json"
