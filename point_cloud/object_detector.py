...
class ObjectDetectorAPI:
    def __init__(self):
        self.yolo = YOLOv4()
        self.yolo.classes = r"F:\Deep Learning\NASA\Yolov4\Yolov4\coco.names"
        self.yolo.make_model()
        self.yolo.load_weights(r"F:\Deep Learning\NASA\Yolov4\Yolov4\yolov4.weights", weights_type="yolo")
